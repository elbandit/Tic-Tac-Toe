...
Scenario: Alternative Diagonal Win Right to Left Token O
	...
	O has won the game!
	 ...
	 """ 
Scenario: Vertical Win Column 1 X Token
    Given that I have started a new game
	And the following moves are played:
      | player | row | column |
      | X | 1 | 1 |
...
Scenario: Vertical Win Column 2 O Token
    Given that I have started a new game
	And the following moves are played:
      | player | row | column |
      | X | 1 | 1 |
...
Scenario: Horizontal Win Row 0 X Token
    Given that I have started a new game
	And the following moves are played:
      | player | row | column |
      | X | 0 | 0 |
	  ...
	  | X | 0 | 1 |
	  | O | 2 | 2 |   	  
    When a player types in the coordinates "0,2"
	Then I should see the following displayed:
    """	
     X | X | X 
    -----------
...
Scenario: Horizontal Win Row 1 O Token
    Given that I have started a new game
	And the following moves are played:
      | player | row | column |
      | X | 0 | 0 |
