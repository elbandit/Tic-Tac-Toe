...
namespace Wrox.BDD.Specs.Core.Domain_Specs
{
    ...
    public class when_checking_if_the_current_player_has_won_the_game : with_a_tictactoe_game 
    {        
        private Because of = () =>
        {
        ...
        {
            line_checker.AssertWasCalled(x => x.contains_a_winning_line(tic_tac_toe_grid));
        };        
    }
}
